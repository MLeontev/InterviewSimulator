...
public class JuniorCodingQuestionsSeed : QuestionSeedBase
{
    protected override IReadOnlyCollection<QuestionDefinition> Questions =>
    [
        new(
            Id: QuestionIds.JuniorTwoSum,
            Title: "Two Sum",
            Text: """
                Дан массив целых чисел nums и целое число target.
                Необходимо вывести индексы двух чисел, сумма которых равна target.
                Гарантируется, что существует ровно одно решение, и один и тот же элемент нельзя использовать дважды.
                Индексы в ответе нужно вывести в порядке возрастания.
                Решение должно читать входные данные из standard input и выводить результат в standard output.
                """,
        ...
        new(
            Id: QuestionIds.JuniorValidAnagram,
            ...
            Text: """
                ...
                Выведите True, если строки являются анаграммами, иначе False.
                Решение должно читать входные данные из standard input и выводить результат в standard output.
                """,
            Type: QuestionType.Coding,
            ReferenceSolution: """
        ...
        new(
            Id: QuestionIds.JuniorFirstUniqueCharacter,
            Title: "Первый неповторяющийся символ",
            Text: """
                Дана строка s.
                Необходимо вывести индекс первого символа, который встречается в строке ровно один раз.
                Если такого символа нет, выведите -1.
                Решение должно читать входные данные из standard input и выводить результат в standard output.
                """,
            Type: QuestionType.Coding,
            ReferenceSolution: """
