...
namespace CodeExecution.UseCases.CodeSubmission.Commands;
    ...
    ICodeExecutor codeExecutor) : IRequestHandler<CheckSubmissionCommand>
{
    ...
    private async Task CompleteAsync(
        Domain.Entities.CodeSubmission submission, 
    ...
    private static CodeSubmissionCompleted ToIntegrationEvent(Domain.Entities.CodeSubmission submission)
    {
