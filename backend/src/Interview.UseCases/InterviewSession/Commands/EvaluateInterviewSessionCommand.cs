    ...
    ILogger<EvaluateInterviewSessionCommandHandler> logger) : IRequestHandler<EvaluateInterviewSessionCommand, Result>
{
    ...
    private SessionQuestionResult MapQuestionResult(Domain.Entities.InterviewQuestion q)
    {
    ...
    private IReadOnlyList<SessionCompetencyResult> BuildCompetencyResults(
        IReadOnlyCollection<Domain.Entities.InterviewQuestion> questions,
    ...
    private string ResolveQuestionFeedbackFallback(Domain.Entities.InterviewQuestion q) =>
        q.Status switch
        {
    ...
    private static string MapQuestionStatusForLlm(Domain.Entities.InterviewQuestion q) =>
        q.Status switch
        {
